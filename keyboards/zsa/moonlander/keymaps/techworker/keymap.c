...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_moonlander_mods(
        RM_TOGG, _________________FUNC_LEFT_________________,       _________________FUNC_RIGHT________________, _______,
    ...
    [_ADJUST] = LAYOUT_moonlander_base(
        _______, ______________ADJUST_L_EXTRA_______________,       ______________ADJUST_R_EXTRA_______________, _______,

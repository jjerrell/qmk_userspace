...
#define WRAPPER_moonlander_base(                                          \
    ...
    LAYOUT_moonlander_wrapper(                                                                                                                                    \
        ...
        K31,      K32,      K33,      K34,      K35, K36,                                         K37,               K38,      K39,      K3A,      K3B,      K3C, \
        _______________HOME_L_EXTRA________________,                   _______,          _______,                    _______________HOME_R_EXTRA________________, \
                                                     ____THUMBS_L____, QK_LEAD,          _______,   ____THUMBS_R____                                              \
    )
// clang-format on
